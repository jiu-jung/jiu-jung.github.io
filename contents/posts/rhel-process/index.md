...
- [프로세스의 시작: **PID 1**](https://jiu-jung.github.io/rhel-process/#프로세스의-시작-PID-1)
- [프로세스의 구조: 계층적 트리](https://jiu-jung.github.io/rhel-process/#프로세스의-구조-계층적-트리)
- [프로세스의 생성과 실행: fork, exec](https://jiu-jung.github.io/rhel-process/#프로세스의-생성과-실행)
- [프로세스 관찰 및 제어: ps, top, kill, nice](https://jiu-jung.github.io/rhel-process/#프로세스-관찰-및-제어-명령어)
...
서로 독립적으로 존재하는 것이 아니라, **부모-자식 관계를 가지는 트리 구조**를 이룬다.

그래서 프로세스를 이해할 때는  
무엇이 실행 중인지만 보는 것이 아니라, **누가 누구를 생성했는가**까지 함께 봐야 한다.
...
부모와 자식은 같은 코드에서 시작하지만, **반환값이 다르기 때문에 이후 서로 다른 동작으로 분기**할 수 있다.
