...
멀티 유저, 멀티 프로세스 운영 환경에서는 각 서비스가 얼마나 CPU와 메모리를 사용할 수 있는지,  
...
- [RHEL에서 보는 cgroup 디렉터리 구조](https://jiu-jung.github.io/rhel-cgroup/#RHEL에서-보는-cgroup-디렉터리-구조)
- [자원 제어의 동작 방식](https://jiu-jung.github.io/rhel-cgroup/#자원-제어의-실제-동작)
- [정리](https://jiu-jung.github.io/rhel-cgroup/#정리)
...
이는 자원 분배의 큰 틀을 나누는 단위라고 볼 수 있다.
